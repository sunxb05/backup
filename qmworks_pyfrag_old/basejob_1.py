...
class Job(object):
    ...
    def __init__(self, name='plamsjob', settings=None,settings_2=None, depend=None):
        ...
        if settings_2 is not None:
            if isinstance(settings_2, Settings):
                self.settings_2 = settings_2.copy()
            if isinstance(settings_2, Job):
                self.settings_2 = settings_2.settings.copy()        
...
#            inp.write(self.get_input_1())
#            inp.write(self.get_input_2())
