...
class Package:
    ...
    def __call__(self, settings,mol, settings_2=None,job_name='', **kwargs):
        """
        ...
        if settings_2:
            job_settings_2 = self.generic2specific(settings_2, mol)
            result = self.run_job(job_settings,mol, job_settings_2, **kwargs)
            return result
        else:
#            job_settings_2 = None
